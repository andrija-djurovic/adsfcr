...
- [Somers’ D for Discriminatory Power in LGD and EAD Models: $D_{yx}$ or $D_{xy}$? (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/mrm/lgd_ccf_dp_somersd_dxy_dyx.pdf)
