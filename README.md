...
- [The Instability of Mean Target Encoding in LGD and EAD Modeling (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/mrm/ols_and_tme_instability.pdf)
