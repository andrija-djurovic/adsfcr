...
- [LGD Downturn Estimation - Regulatory Requirements, Methods, and Challenges (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/lgd/lgd_dt_estimation.pdf)
...
- [Supervised Macroeconomic Index for IFRS9 Forward-Looking Modeling - The `Python` Package `smi` (pdf, manual, `Python` code)](https://github.com/andrija-djurovic/adsfcr/blob/main/model_dev_and_vld/smi_py/smi_py_manual.pdf)
...
- [Statistical Binning of Categorical Risk Factors - PD Modeling (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/model_dev_and_vld/cat_rf_bin.pdf)
...
- [Backtesting PD Models - From Homogeneous Grades to Heterogeneous Portfolios (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/risk_quantification/from_homogeneous_grades_to_heterogeneous_portfolios.pdf)
- [LGD Backtesting under Discrete Rating Scales - Revisiting the Statistical Assumptions of Standard ECB Validation Procedures (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/risk_quantification/ecb_instructions_lgd_ccf_backtesting.pdf)
...
- [Encoding Categorical Risk Factors in IRB LGD and EAD Models - A Comparison of the Target-Based Encoding Methods (pdf, presentation)](https://github.com/andrija-djurovic/adsfcr/blob/main/ols/ols_and_rf_target_based_encoding.pdf)
